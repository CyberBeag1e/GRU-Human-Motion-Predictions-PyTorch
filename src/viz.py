...
class Ax3DPose(object):
    def __init__(self, ax: plt.Axes, lcolor = "#3498db", rcolor = "#e74c3c"):
        """
    ...
    def update(self, channels: np.ndarray, lcolor = "#3498db", rcolor = "#e74c3c"):
        """
        ...
        assert channels.size == 96, f"channels should have 96 entries, it has {channels.size: d} instead"
